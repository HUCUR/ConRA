...
document.addEventListener('DOMContentLoaded', function () {
    ...
    startOverBtn.addEventListener('click', function () {
        ...
        if (confirm("Do you want to start over?")) {
            // Redirect to index.html if user clicks OK
    ...
    showResultsBtn.addEventListener('click', function () {
        ...
        const idleTime = JSON.parse(sessionStorage.getItem('idleTime'));
        const duration_end_reason = JSON.parse(sessionStorage.getItem('duration_end_reason'));
        ...
        resultsContent.innerHTML = `
            ...
            <p> Idle Time Out : ${(idleTime / 1000).toFixed(2)} (secs) / ${(idleTime / 60000).toFixed(2)} (mins) </p>
            <p> Assessment ended due to : ${duration_end_reason}</p>
